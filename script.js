...
function parseExif(view, tiffStart, tiffEnd) {
  ...
  for (let i = 0; i < entryCount; i++) {
    ...
    else if (tag === 0x0132) dateTimeFallback = readIFDAscii(entry, view, tiffStart, tiffEnd, get16, get32);
  }
...
function isJpg(filename) { return /\.jpe?g$/i.test(filename); }
...
// Reverse the already-loaded gallery. No network request is made here.
